...
class NodeSelectorApp():
    def __init__(self, frame, user_info):
        ...
        sitting = None
        #print("self.homemaster.Shops_info ", self.homemaster.Shops_info)
        if self.homemaster.Shops_info and self.homemaster.Shops_info['Selected_Shop']['Shop_Items_type'] and not self.homemaster.Shops_info['Selected_Shop']['Shop_Items_type'] == "":
             self.nodes = json.loads(self.homemaster.Shops_info['Selected_Shop']['Shop_Items_type'])
        else:
            self.nodes = nodes
