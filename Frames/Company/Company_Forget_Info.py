...
class Company_Forget_Info_Frame(tk.Frame):
    def __init__(self, parent, Canceal_callback, User_data, Shop_data):
        ...
        tk.Label(self.details_frame,
                 text="Hello! Pless Fill Those Your Profil To fined Your Company."
        ...
        self.forget_password_label = tk.Label(self.details_frame, text="User Found Did You Forgot Password?", fg="red", cursor="hand2")
        ...
        self.add_button = tk.Button(self.details_frame, text='Find', command=self.add_user)
        self.cancle_button = tk.Button(self.details_frame, text='Cancle', command=self.Canceal_callback)


        self.f_and_lname_label.grid(row=1, column=0, padx=5, pady=5, sticky=tk.W)
        self.fname_entry.grid(row=1, column=1, padx=5, pady=5, sticky=tk.W)
        self.name_label.grid(row=1, column=2, padx=5, pady=5, sticky=tk.W)
